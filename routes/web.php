...
Route::get('addTask',[TaskController::class,'createTask']);
...
Route::get('deleteTask/{id}',[TaskController::class,'destroy']);
Route::post('updateCompletion/{id}', [TaskController::class, 'updateCompletion'])->name('tasks.updateCompletion');
